...
public class TransferBrowserFactory implements ToolWindowFactory {
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
     ...
     private List<AnAction> createToolWindowActions() {
         ...
         AnAction customAction = new AnAction("Reload", "Reload the Transfer", icon) {
             @Override
             public void actionPerformed(@NotNull AnActionEvent e) {
                 try {
                     browser.getCefBrowser().loadURL(BGZS.getReader().getTransfer());
